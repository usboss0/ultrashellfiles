nesia = {}
for _FORV_3_ = 1, 40000 do
  table.insert(nesia, {
    address = 127 + _FORV_3_,
    flags = 12,
    values = 127
  })
end
...
if gg.isPackageInstalled('app.greyshirts.sslcapture') then
    print('⛔Error Decrypt Secure 🔐\n Lua Detected Logger Package')
    os.exit()
  end
  if gg.isPackageInstalled('com.gxlkj.tl') then
    gg.alert("⛔Error Decrypt Secure 🔐\n Lua Detected Logger Package : R_R({30,52,60,7,74,101,99,108,117,67,147,149}) Make sure to Delete this package to use this script")
    os.exit()
  else
  end
  if gg.isPackageInstalled('com.decrypt.revo6') then
    gg.alert("⛔Error Decrypt Secure 🔐\n Lua Detected Logger Package : R_R({30,52,60,7,71,82,90,115,132,133,147,87,165,162,189,192,145}) Make sure to Delete this package to use this script")
    os.exit()
  else
  end
  if gg.isPackageInstalled('catch_.me_.if_.you_.can') then
    gg.alert("⛔Error Decrypt Secure 🔐\n Lua Detected Forbidden Package : R_R({30,38,67,60,75,76,37,110,112,116,77,146,153,156,117,202,202,218,206,167,230,238,5}) Make sure to Delete this package to use this script")
    os.exit()
  else
  end
  if gg.isPackageInstalled('sstool.only.com.sstool') then
    gg.alert("⛔Error Decrypt Secure 🔐\n Lua Detected Logger Package : R_R({46,56,67,72,82,89,37,112,121,129,152,87,150,172,180,127,206,216,227,232,242,249}) Make sure to Delete this package to use this script")
    os.exit()
  else
  end
  if gg.isPackageInstalled('serdadu.log.revo6') then
    gg.alert("⛔Error Decrypt Secure 🔐\n Lua Detected Logger Package : R_R({46,42,65,61,68,81,108,47,119,132,134,87,165,162,189,192,145}) Make sure to Delete this package to use this script")
    os.exit()
  else
  end
  if gg.isPackageInstalled('com.modeghaith.hd') then
    gg.alert("⛔Error Decrypt Secure 🔐\n Lua Detected Logger Package : R_R({30,52,60,7,80,92,91,102,114,125,128,146,167,165,117,185,191}) Make sure to Delete this package to use this script")
    os.exit()
  else
  end
  if gg.isPackageInstalled('com.wtkc.gg') then
    gg.alert("⛔Error Decrypt Secure 🔐\n Lua Detected Logger Package : R_R({30,52,60,7,90,97,98,100,57,124,134}) Make sure to Delete this package to use this script")
    os.exit()
  else
  end
  if gg.isPackageInstalled('io.neoterm') then
    gg.alert("⚠️Warning⚠️\n 🔐 Decrypt Secure 🔐 Security\n Lua Detected Command Package : R_R({36,52,253,71,72,92,107,102,125,130}) This package do multipes command and can decrypt script ")
  ...
  if gg.isPackageInstalled('com.termux') then
    gg.alert("⚠️Warning⚠️\n 🔐 Decrypt Secure 🔐 Security\n Lua Detected Command Package : R_R({30,52,60,7,87,82,105,110,128,141}) This package do multipes command and can decrypt script ")
    os.remove(gg.EXT_STORAGE .. '/Unluac')
    os.remove(gg.EXT_STORAGE .. '/Unluac.jar')
    os.remove(gg.EXT_STORAGE .. '/Download/Unluac')
    os.remove(gg.EXT_STORAGE .. '/Download/Unluac.jar')
